...
arm-none-eabi-gcc -O3 -std=c99 -static -nostdlib -Wall -Wno-strict-aliasing -fomit-frame-pointer \
-mfloat-abi=hard -fsingle-precision-constant -Wdouble-promotion -mfpu=fpv4-sp-d16 \
-ffast-math -fwhole-program -fstrict-aliasing -mcpu=cortex-m4 -mthumb  \
-Iinc \
